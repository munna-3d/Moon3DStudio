...
export default function Navbar() {
  ...
  // Close mobile menu on route change without cascading renders
  ...
  // Do not render public navbar in admin portal (checked after all hooks)
  ...
  return (
    ...
    >
      <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between">
        {/* Brand Logo */}
        <Link href="/" className="flex items-center gap-2.5 group" aria-label="Moon 3D Studio Home">
      ...
      {mobileMenuOpen && (
        <nav
          ...
          className="md:hidden fixed inset-x-0 top-[65px] bg-[#090a0d]/98 border-b border-white/10 px-6 py-8 shadow-2xl backdrop-blur-xl animate-in slide-in-from-top-4 duration-200"
        >
